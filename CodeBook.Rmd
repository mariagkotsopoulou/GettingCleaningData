...
The above mentioned sensors are the accelerometer and the gyroscope. The signals capetured by
...
```
Lastly the dataset `datacast` which is a tidy data set is saved as a csv at the working directory with the name UCIHARTidyData. 
